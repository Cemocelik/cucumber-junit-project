Feature: Web table user order feature
  ...
  @webtableAppOrder
  Scenario Outline:   Scenario: User should be able to place order and order seen in web table
    Given user is already logged in and on order page
    ...
    Examples:Famous female scientist
      | product type | quantity | customer name     | street            | city   | state   | zipcode | credit card type | credit card number | expiry date | expectedName      |
